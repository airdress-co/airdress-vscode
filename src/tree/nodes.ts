...
/**
 * Tree node data model (SPEC-057 T6-06, design §6).
 *
 * The SPEC-042 boundary is stated IN THE TYPES, not in review: the
...
/**
 * Field names that could carry SPEC-042-protected content. Declaring
